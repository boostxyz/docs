---
title: "One-Time Actions Architecture"
description: "An overview of the One-Time Actions protocol architecture and its components"
---

import ClaimFlow from '/snippets/claim-flow.mdx';

<Frame caption="High Level Overview of One-Time Actions">
