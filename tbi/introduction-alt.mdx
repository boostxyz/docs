...
description: "An alternate Time-Based Incentives introduction focused on product teams"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Integrate" icon="code" href="/tbi/integrate/api-overview">
    Surface campaigns, user rewards, and claims in your own product.
  </Card>
</CardGroup>
